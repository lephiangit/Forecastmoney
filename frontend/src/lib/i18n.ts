...
export const translations = {
  en: {
    ...
    retry: "Retry",
    chartLoadFailed: "Could not load this data. The server may be busy or rate-limiting requests.",
    chartNoData: "No data available for this asset yet.",
    botStartFailed: "Could not start the bot",
    ...
    backtestSubtitle: "Simulate AI strategies on historical data",
  ...
  vi: {
    ...
    translatedByAi: "Bản dịch do AI tạo",
    ...
    retry: "Thử lại",
    chartLoadFailed: "Không tải được dữ liệu này. Máy chủ có thể đang bận hoặc đang giới hạn tần suất.",
    chartNoData: "Chưa có dữ liệu cho mã này.",
    botStartFailed: "Không bật được bot",
    actionFailed: "Thao tác không thực hiện được",
    updated: "Cập nhật",
    ...
    backtestSubtitle: "Mô phỏng chiến lược AI trên dữ liệu lịch sử",
    ...
    movingAverage: "Đường trung bình",
    showIndicators: "Hiện chỉ báo",
    hideIndicators: "Ẩn chỉ báo",
    // price alerts
    ...
    noAlerts: "Chưa đặt cảnh báo nào.",
